...
$mysqle =  "SELECT * FROM exit_requests";
$result = mysqli_query($con,$mysqle);


if(mysqli_num_rows($result)!=0){

$stmt = $con->prepare("SELECT id,id_family,destination,reason_visit,family_kinship,destination_phone,startDateVisit	,endDateVisit,building_id FROM  exit_requests ");
